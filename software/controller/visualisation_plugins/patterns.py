...
class PatternFilter(Filter):
    ...
    def process(self, frame):
        if self.__requiresNewFrame():
            ...
            self.__currentFrame = PatternsVisualisationPlugin.apply(self.__filters,
                                                                    self.__pattern.frames[self.__frameIndex])
...
class MotionBlurFilter(Filter):
    ...
    def __overlay(self, topFrame, bottomFrame):
        ...
        return [[self.__blend(pair[0], pair[1]) for pair in zip(rowPairs[0], rowPairs[1])] for rowPairs in
                frameOfPairedRows]
...
class PatternsVisualisationPlugin(VisualisationPlugin):
    ...
    def configure(self, config):
        ...
        self.add_to_pattern_repo("Nyan Cat", os.path.join(self.plugin_resource_directory, "nyan.csv"),
                                 self.__beatService)

        # Knight Rider: A scanning bar going from left to right and back again,
        #  with a blur, and a changing colour
        self.add_to_pattern_repo("Knight Rider", os.path.join(self.plugin_resource_directory, "knightRider.csv"),
                                 self.__beatService,
                                 [
        ...
        self.add_to_pattern_repo("Explode A.1", os.path.join(self.plugin_resource_directory, "explodeA.csv"),
                                 self.__beatService,
                                 [
                                     MotionBlurFilter(0.9)
                                 ],
        ...
        self.add_to_pattern_repo("Matrix", os.path.join(self.plugin_resource_directory, "matrix.csv"),
                                 self.__beatService,
                                 [
        ...
        self.add_to_pattern_repo("Knight Rider 2", os.path.join(self.plugin_resource_directory, "knightRider.csv"),
                                 self.__beatService,
                                 [
                                     MotionBlurFilter(0.9)
                                 ],
        ...
        self.add_to_pattern_repo("Matrix 2", os.path.join(self.plugin_resource_directory, "matrix.csv"),
                                 self.__beatService,
                                 [
                                     MotionBlurFilter(0.95)
                                 ],
        ...
        self.add_to_pattern_repo("Explode 0.1", os.path.join(self.plugin_resource_directory, "explode.csv"),
                                 self.__beatService,
                                 [
                                     MotionBlurFilter(0.9)
                                 ],
        ...
        self.add_to_pattern_repo("Explode 2.1", os.path.join(self.plugin_resource_directory, "explode2.csv"),
                                 self.__beatService,
                                 [
                                     MotionBlurFilter(0.9)
                                 ],
        ...
        self.add_to_pattern_repo("Wavey Wave", os.path.join(self.plugin_resource_directory, "waveyWave.csv"),
                                 self.__beatService,
                                 None,
                                 [ColourFilter((0.0, 0.0, 1.0)), BeatHueAdjustmentFilter(self.__beatService, 0.2)])

        self.add_to_pattern_repo("Diamond", os.path.join(self.plugin_resource_directory, "diamond.csv"),
                                 self.__beatService,
                                 [
